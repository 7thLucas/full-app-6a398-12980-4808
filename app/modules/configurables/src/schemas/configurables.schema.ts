...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "defaultBusinessName",
      type: "string",
      required: false,
      label: "Default Business Name (Demo)",
    },
    {
      fieldName: "defaultLocale",
      type: "string",
      required: false,
      label: "Default Demo Locale",
    },
    {
      fieldName: "defaultIndustry",
      type: "enum",
      required: false,
      label: "Default Demo Industry",
      options: ["Plumber", "Contractor", "Landscaper", "Electrician", "Boutique Shop", "Other"],
    },
    {
      fieldName: "hourlyTradeRate",
      type: "number",
      required: false,
      label: "Trade Rate ($/hr for analytics)",
      min: 50,
      max: 1000,
    },
    {
      fieldName: "avgJobValue",
      type: "number",
      required: false,
    ...
    {
      fieldName: "enableOnboarding",
      type: "boolean",
      required: false,
      label: "Show Onboarding Wizard",
    },
    {
      fieldName: "queueTabLabel",
      type: "string",
      required: false,
      label: "Queue Tab Label",
    },
    {
      fieldName: "leadsTabLabel",
      type: "string",
      required: false,
      label: "Leads Tab Label",
    },
    {
      fieldName: "reviewsTabLabel",
      type: "string",
      required: false,
      label: "Reviews Tab Label",
    },
    {
      fieldName: "analyticsTabLabel",
      type: "string",
      required: false,
      label: "Analytics Tab Label",
    },
    {
      fieldName: "approveButtonLabel",
      type: "string",
      required: false,
    ...
    {
      fieldName: "leadHubHeading",
      type: "string",
      required: false,
      label: "Lead Hub Screen Heading",
    },
    {
      fieldName: "reputationHeading",
      type: "string",
      required: false,
      label: "Reputation Radar Screen Heading",
    },
    {
      fieldName: "analyticsHeading",
      type: "string",
      required: false,
      label: "Growth Analytics Screen Heading",
    },
    {
      fieldName: "localVisibilityScore",
      type: "number",
      required: false,
    ...
    {
      fieldName: "monthlySavedHours",
      type: "number",
      required: false,
      label: "Monthly Hours Saved (Analytics)",
      min: 0,
      max: 200,
    },
    {
      fieldName: "highIntentLeadCount",
      type: "number",
      required: false,
      label: "High Intent Lead Count (Analytics)",
      min: 0,
      max: 100,
    },
    {
      fieldName: "reviewConversionCount",
      type: "number",
      required: false,
      label: "Review Conversion Count (Analytics)",
      min: 0,
      max: 100,
    },
    {
